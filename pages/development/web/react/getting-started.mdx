...
<Tabs items={['npm', 'yarn']}>
  <Tab>```bash npx create-react-app [app_name] ```</Tab>
  <Tab>```bash yarn create react-app [app_name] ```</Tab>
</Tabs>

Typescript

<Tabs items={['npm', 'yarn']}>
  <Tab>```bash npx create-react-app [app_name] --template typescript ```</Tab>
  <Tab>```bash yarn create react-app [app_name] --template typescript ```</Tab>
</Tabs>
...
<Tabs items={['npm', 'yarn']}>
  <Tab>```bash npm init @vitejs/app [app_name] --template react ```</Tab>
  <Tab>```bash yarn create @vitejs/app [app_name] --template react ```</Tab>
</Tabs>

TypeScript

<Tabs items={['npm', 'yarn']}>
  <Tab>```bash npm init @vitejs/app [app_name] --template react-ts ```</Tab>
  <Tab>```bash yarn create @vitejs/app [app_name] --template react-ts ```</Tab>
</Tabs>
...
<Tabs items={['npm', 'yarn']}>
  <Tab>```bash npx create-next-app [app_name] ```</Tab>
  <Tab>```bash yarn create next-app [app_name] ```</Tab>
</Tabs>
